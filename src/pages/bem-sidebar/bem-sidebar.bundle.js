...
var _sidebar = require('./blocks/sidebar/sidebar.jsx');
...
},{"./blocks/sidebar/sidebar.jsx":162}],160:[function(require,module,exports){
'use strict';
...
var _treeInspect = require('../tree-inspect/tree-inspect.jsx');

var _treeInspect2 = _interopRequireDefault(_treeInspect);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_treeInspect2.default, { data: this.props.data.params })
                )
            );
        }
    }]);
...
},{"../tree-inspect/tree-inspect.jsx":163,"react":158}],161:[function(require,module,exports){
'use strict';
/**
...
function createEvalHelper(callback) {
  ...
  function wrapFunction(fnName, fnString) {
    return '(function (NAMESPACE) {' + 'window["' + extensionNamespace + '"].' + fnName + ' = ' + fnString + ';' + '})("' + extensionNamespace + '");';
  }
  var helper = {
    /**
     * Define a function
     ...
     */
    defineFunction: function defineFunction(name, string, callback) {
      chrome.devtools.inspectedWindow.eval(wrapFunction(name, string) + getSrcURL(), function (result, error) {
     ...
     */
    defineFunctions: function defineFunctions(functionObjects, callback) {
      var toEval = '';
     ...
     */
    executeFunction: function executeFunction(name, args, callback, lhs) {
      var params = '(';
      ...
      params += ')';
      var toEval = (lhs ? 'window["' + extensionNamespace + '"].' + lhs + ' = ' : '') + 'window["' + extensionNamespace + '"].' + name + params + ';';
      toEval += getSrcURL();
      chrome.devtools.inspectedWindow.eval(toEval, function (result, error) {
        callback && callback(result, error);
      });
  ...
  chrome.devtools.inspectedWindow.eval('window["' + extensionNamespace + '"] = {};', function (result, error) {
    // Define cleanUp
    helper.defineFunction('cleanUp', cleanUp.toString(), function (result, error) {
      ...
      chrome.devtools.inspectedWindow.eval('window.addEventListener("clean-up", ' + 'window["' + extensionNamespace + '"].cleanUp);', function (result, error) {
        if (error) {
          throw error;
        }
...
exports.default = createEvalHelper;
...
var _block = require('../block/block.jsx');

var _block2 = _interopRequireDefault(_block);

var _evalHelper = require('../eval-helper/eval-helper.js');

var _evalHelper2 = _interopRequireDefault(_evalHelper);
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        value: function componentDidMount() {
            var self = this;
            (0, _evalHelper2.default)(function (helper) {
        ...
        key: 'elementSelected',
        value: function elementSelected() {
            var self = this;
        ...
        value: function render() {
            ...
            if (blocks) {
                var layout = Object.keys(blocks).map(function (blockName) {
                    return _react2.default.createElement(_block2.default, { data: { name: blockName, params: blocks[blockName] } });
                });
                return _react2.default.createElement(
                    'div',
                    { className: 'blocks' },
...
},{"../block/block.jsx":160,"../eval-helper/eval-helper.js":161,"react":158,"react-dom":2}],163:[function(require,module,exports){
'use strict';
...
var TreeInspect = function (_React$Component) {
    _inherits(TreeInspect, _React$Component);

    function TreeInspect(props) {
        _classCallCheck(this, TreeInspect);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TreeInspect).call(this, props));
    ...
    _createClass(TreeInspect, [{
        key: 'onCollapseToggle',
        value: function onCollapseToggle() {
            this.setState({
        ...
        value: function render() {
            ...
            if (label) {
                if (Object.keys(data).length) {
                    return _react2.default.createElement(
                        'li',
                        { className: 'tree-inspect__item' },
                        _react2.default.createElement(
                            'span',
                            { className: 'tree-inspect__label tree-inspect__label_type_object' },
                            _react2.default.createElement('i', { className: "tree-inspect__collapse-toggle  tree-inspect__collapse-toggle_collapsed_" + (self.state.collapsed ? 'yes' : 'no'), onClick: self.onCollapseToggle.bind(self) }),
                            label
                        ),
                        _react2.default.createElement(
                            'div',
                            { className: "tree-inspect__inner tree-inspect__inner_collapsed_" + (self.state.collapsed ? 'yes' : 'no') },
                            _react2.default.createElement(TreeInspect, { data: data })
                        )
                    );
                } else {
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'span',
                            { className: 'tree-inspect__label tree-inspect__label_type_primitive' },
                            label
                        ),
                        _react2.default.createElement(
                            'span',
                            { className: 'tree-inspect__value' },
                            "{}"
                        )
                    );
                }
            } else {
                var nodes = Object.keys(data).map(function (node, index) {
                    var value = data[node];
                    if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object') {
                        return _react2.default.createElement(TreeInspect, { data: value, label: node });
                    } else {
                        return _react2.default.createElement(
                            'li',
                            { className: 'tree-inspect__item' },
